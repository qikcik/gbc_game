...
..\..\..\bin\lcc -Wa-l -Wl-m -DGBDK_2_COMPAT -autobank -Wb-v -Wl-yt19 -Wl-yo4 -Wl-ya4 -o autobanks.gb banks.o srcfile_2.o srcfile_3.o srcfile_4_not-autobanked.o srcfile_1.o 
